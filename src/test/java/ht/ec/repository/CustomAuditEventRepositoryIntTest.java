package ht.ec.repository;

import ht.ec.EcApp;
import ht.ec.config.Constants;
import ht.ec.config.audit.AuditEventConverter;
import ht.ec.domain.PersistentAuditEvent;
...
import static ht.ec.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
